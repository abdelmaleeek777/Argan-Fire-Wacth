...
export default function AdminAlerts() {
        ...
        prev.map((a) =>
          a.id === alertId
            ? {
                ...
                status: newStatus,
                resolvedAt:
                  newStatus === "RESOLUE" ? new Date().toISOString() : null,
              }
            : a,
        ),
      );
  ...
  const stats = {
    ...
    critical: alerts.filter(
      (a) => a.severity === "CRITIQUE" && a.status !== "RESOLUE",
    ).length,
  };
    ...
    <div className="space-y-6">
          ...
          {[
            {
              ...
              value: stats.total,
              icon: Activity,
              color: "from-slate-500/50 to-slate-600/50",
            ...
            },
            {
              ...
              value: stats.open,
              icon: AlertTriangle,
              color: "from-rose-500/50 to-rose-600/50",
            ...
            },
            {
              ...
              icon: Flame,
              color: "from-rose-600/50 to-red-700/50",
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p
                    className={`text-3xl font-black ${stat.danger && stat.value > 0 ? "text-rose-200" : "text-white"} mt-1`}
                  >
                    {stat.value}
                  </p>
                </div>
                <stat.icon
                  className={`w-8 h-8 ${stat.danger && stat.value > 0 ? "text-rose-300" : "text-white/40"}`}
                />
              </div>
            </div>
          ))}
      ...
      {loading ? (
        <div className="bg-gradient-to-br from-slate-50 to-white rounded-3xl border border-slate-200 p-20 flex flex-col items-center justify-center">
          ...
          <p className="text-slate-500 font-bold mt-6">
            Scanning for alerts...
          </p>
        </div>
          ...
          {filteredAlerts.map((alert) => {
            ...
            return (
              ...
              >
                ...
                {isCritical && isOpen && (
                  <div
                    className="absolute inset-0 bg-gradient-to-r from-rose-500 via-orange-500 to-rose-500 opacity-100 animate-pulse"
                    style={{
                      padding: "2px",
                      WebkitMask:
                ...
                <div className="relative p-6">
                  <div className="flex items-start gap-5">
                    {/* Icon */}
                    <div
                      className={`relative shrink-0 w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg ${
                        isCritical
                          ? "bg-gradient-to-br from-rose-500 to-orange-600 shadow-rose-200"
                          : isOpen
                    ...
                    >
                      ...
                      {(isOpen || isInProgress) && (
                        <span className="absolute -top-1 -right-1 w-4 h-4 bg-white rounded-full flex items-center justify-center">
                          <span
                            className={`w-2.5 h-2.5 rounded-full animate-ping ${isCritical ? "bg-rose-500" : isOpen ? "bg-amber-500" : "bg-blue-500"}`}
                          ></span>
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <span
                          className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-full flex items-center gap-1.5 ${
                            isOpen
                        ...
                        >
                          <span
                            className={`w-1.5 h-1.5 rounded-full ${isOpen || isInProgress ? "bg-white animate-pulse" : "bg-white/60"}`}
                          ></span>
                          {isOpen
                            ? "OPEN"
                            : isInProgress
                      ...
                      <h3 className="font-black text-xl text-slate-800 mt-3">
                        {alert.cooperative}
                      </h3>
